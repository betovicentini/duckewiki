...
"<script type='text/javascript'>
      function limpaEXISTE() {
        $.post('batchenter-demarcaexiste.php', { tbname: '".$tbname."'}, function(data) {
        if (data=='Concluido') {
                mygrid.uncheckAll();
        }
        });
...
&nbsp;
<input type='button' style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"  onclick=\"javascript:exportGRIDasCSV();\" value='Exportar TXT' onmouseover=\"Tip('Exporta como TXT separado por TAB<br />Rápido, mas precisa visualizar todas as páginas antes de clicar aqui!');\" />

";
if ($sampletype!='especimenes') {
echo "&nbsp;
<input  type='button'  style=\"color:#339933; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"   value='Gerar Amostras'  onclick = \"javascript:small_window('batchenter-plantas-criaamostras.php?tbname=".$tbname."',700,500,'Gerar amostras para plantas marcadas');\" >
&nbsp;
<input  type='button'  style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"   value='Exporta Tabela NIR'  onclick = \"javascript:small_window('export-nir-spreadsheet.php?wikiid=1&sampletype=plantas&tbname=".$tbname."&ispopup=1',650,300,'Exporta planilha NIR');\" >
&nbsp;
...
echo "
&nbsp;
<input  type='button'  style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"   value='Exporta Tabela NIR'  onclick = \"javascript:small_window('export-nir-spreadsheet.php?wikiid=1&sampletype=specimens&tbname=".$tbname."&ispopup=1',650,300,'Exporta planilha NIR');\" >
";
}

echo "
&nbsp;
<input  type='button'  style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"   value='Desmarca EXISTE'  onclick = \"javascript:limpaEXISTE();\" >
    </div>
  </td>
</tr>";
/////////////////javascript:small_window('batchenter-demarcaexiste.php?tbname=".$tbname."&ispopup=1',650,300,'Desmarca os registros marcados como EXISTE');\" >

function changeoptionlist(varvalue, gazid, selval)
{
if (varvalue=="")
  {
...
xmlhttp.onreadystatechange=function()
 ...
 xmlhttp.open("GET","changetaxalist.php?gazetteerid="+gazid+"&onme="+varvalue+"&stspecid="+selval,true);
 xmlhttp.send();
} 
...
function changemapimgform(gazid, formid, containerid)
{	
if (window.XMLHttpRequest)
  {// code for IE7+, Firefox, Chrome, Opera, Safari
...
xmlhttpform.onreadystatechange=function()
 ...
 xmlhttpform.open("GET","graph_plotmap_imgform.php?gazetteerid="+gazid+"&containerid="+containerid,true);
 xmlhttpform.send();
} 

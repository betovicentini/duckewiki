...
<br />
        <a href=\"".$path.$rusqw['FileName']."\" class=\"jqzoom\" rel='gal1'  >
            <img src=\"".$urllow.$rusqw['FileName']."\"    title=\"\" style=\"border: 4px solid #666;\">
        </a>
...
<li><a class=\"zoomThumbActive\" href='javascript:void(0);' rel=\"{gallery: 'gal1', smallimage: '".$urllow.$rusqw['FileName']."',largeimage: '".$path.$rusqw['FileName']."', title: '".$simplenome."' }\"><img width=100px; src='".$urllow.$rusqw['FileName']."' onmouseover=\"Tip('".$simplenome." - ".$oiden."');\"  onclick=\"javascript:changetxtmenu('".$vimg."menu','".$vimg."txt');\" ></a></li>";
		} else {
		$txt .= "
<li><a href='javascript:void(0);' rel=\"{gallery: 'gal1', smallimage: '".$urllow.$rusqw['FileName']."',largeimage: '".$path.$rusqw['FileName']."', title: '".$simplenome."'}\"><img width=100px; src='".$urllow.$rusqw['FileName']."' onmouseover=\"Tip('".$simplenome." - ".$oiden."');\"  onclick=\"javascript:changetxtmenu('".$vimg."menu','".$vimg."txt');\" title: '".$simplenome."' ></a></li>";
	}

...
if ($erros>0) {
				...
				unset($enviado);
echo "
<table  align='center' class='erro' border=\"0\" cellpadding=\"7\" cellspacing=\"0\">";
...
if (!empty($gazetteerid) && $gazetteerid>0) {
	...
	$titulo =  GetLangVar('namecadastrar')." ".strtolower(GetLangVar('namenova')." ".GetLangVar('namegazetteer'));
}
echo "

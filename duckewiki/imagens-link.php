...
"<script>
  function mudarimagem(skip) {
      var time = new Date().getTime();
      $.get('imagens-getimg.php', { t: time, skip: skip}, function (data) {
...
<br />
<input type='button' onclick=\"window.close();\" style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"  value='Fechar' />
&nbsp;
<input type='button' onclick=\"mudarimagem(0)\"  value='Mudar imagem' />

...
<br />
<input type=\"submit\" style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\" value='Save' >
<form>
";
echo "
<br />
...
echo "
<tr><td>".$hh."</td><td>
<input type=\"button\" style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\" value='Imprime Lista' onclick=\"javascript:small_window('processo-exportvarios-herbaria-printlista.php?processoid=".$processoid."&herbario=".$hh."');\" onmouseover=\"Tip('Imprimir a lista para o pacote do herbário');\" ></td></tr>";
}
echo "
</table>";

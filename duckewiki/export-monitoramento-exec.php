...
if (!isset($prepared)) {
	...
	if (count($basicvariables)>0) {
		...
		if ($formvariables>0) {
			...
			$qu = "SELECT tr.TraitID,tr.TraitTipo,tr.TraitName,tr.TraitUnit,tr.TraitDefinicao, tr.PathName FROM Traits as tr WHERE tr.FormulariosIDS LIKE '%formid_".$formvariables."%'";

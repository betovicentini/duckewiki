...
if ($datatype=='planta') { $title= GetLangVar('namecoordenadas')." ".strtolower(GetLangVar('nametaggedplant'));}
if ($datatype=='amostracoletada') { $title= GetLangVar('namecoordenadas')." ".strtolower(GetLangVar('nameamostra'))."s ".strtolower(GetLangVar('namecoletada'))."s";}

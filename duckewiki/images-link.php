...
<tr>
  ...
  <td>
	...
	echo "
              <tr bgcolor = '".$bgcolor."'>
                <td class='tdsmallbold'>Relacionar com uma ".strtolower(GetLangVar('nameamostra'))."&nbsp;<img height=14 src=\"icons/icon_question.gif\"";
	...
	echo "
		...
		if ($bgi % 2 == 0) { $bgcolor = $linecolor2;} else { $bgcolor = $linecolor1 ;} $bgi++;
			echo "
            <tr bgcolor = '".$bgcolor."'>
              <td class='tdsmallbold'>Relacionar com uma ".strtolower(GetLangVar('nametaggedplant'))."&nbsp;<img height=14 src=\"icons/icon_question.gif\"";
	...
	echo "
            <tr bgcolor = '".$bgcolor."'>
              <td class='tdsmallbold' >Relacionar com um ".strtolower(GetLangVar('namehabitat'))."&nbsp;<img height=14 src=\"icons/icon_question.gif\"";

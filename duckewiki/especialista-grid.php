...
<tr>
  ...
  <input type='button' style=\"color:#4E889C; font-size: 1em; padding: 4px; cursor:pointer;\"  onmouseover=\"Tip('Cadastrar um novo especialista');\" onclick = \"javascript:small_window('novapessoa-form.php?submitted=novo&ispopup=1',800,500,'Pessoas');\" value='Novo especialista'  />
";
if (!$processoid>0) {
echo "
&nbsp;
<input type='button' style=\"color:#4E889C; font-size: 1em; padding: 4px; cursor:pointer;\"  onclick=\"javascript:add_r();\" value='Adicionar linha' onmouseover=\"Tip('Adicionar nova linha à tabela (será colocada na segunda posição)');\" />";
}
//echo "&nbsp;<input type='button' style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"  onclick=\"javascript:updateOutput();\" value='Exportar TXT' onmouseover=\"Tip('Exporta como TXT separado por TAB');\" />
echo "
&nbsp;
  <input type='button' style=\"color:#4E889C; font-size: 1em; padding: 4px; cursor:pointer;\"  onmouseover=\"Tip('Exportar planilha com especialistas');\" onclick = \"javascript:small_window('export-especialistas.php',700,500,'Especialistas');\" value='Exportar especialistas'  />
&nbsp;
  <input type='button' style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"  onmouseover=\"Tip('Importar planilha com especialistas');\" onclick = \"javascript:small_window('import-especialistas-form.php',700,500,'Importar Especialistas');\" value='Importar especialistas'  />
    </div>
  </td>
</tr>";

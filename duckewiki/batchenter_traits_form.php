...
echo "
<form method='post' name='finalform' action='batchenter_traits_gridform.php'>
       ...
       <td class='tdformnotes'>
          <table>
            <tr>
              ...
              <td align='right' class='tdformnotes' ><input type='radio' name='sampletype' checked value='especimenes' /></td>
              <td align='left' class='tdformnotes'>especimenes</td>
              <td align='right' class='tdformnotes' ><input type='radio' name='sampletype' value='plantas' /></td>

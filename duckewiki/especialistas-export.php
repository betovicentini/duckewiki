...
$qq = "SELECT p.Prenome, p.SegundoNome, p.Sobrenome,p.Email,p.Abreviacao,
f.Familia, (SELECT GROUP_CONCAT(gg.Genero SEPARATOR ';') FROM Tax_Generos AS gg WHERE gg.EspecialistaID=e.EspecialistaID) as Generos,e.Herbarium FROM Especialistas as e LEFT JOIN Pessoas as p ON p.PessoaID=e.Especialista LEFT JOIN Tax_Familias as f ON f.FamiliaID=e.FamiliaID
ORDER BY f.Familia";

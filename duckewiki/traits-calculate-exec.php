...
<form action='traits-calculate-form.php' method='post'>
  <input type='hidden' name='filtro' value=".$filtro." />
  <input type='hidden' name='formula' value=".$formula." />
  <input type='submit' value='".GetLangVar('nameselect')." ".strtolower(GetLangVar('nameoutra'))."' class='bblue' />
</form>
</td>
</tr>
</table>";
...
<form action='edit-batch-exec.php' method='post'>
  ...
  <input type='submit' value='".GetLangVar('nameeditar')." ".strtolower(GetLangVar('namedata'))."' class='bsubmit' />
</form>
</td>
<td>
<form action='traits-calculate-form.php' method='post'>
  <input type='hidden' name='filtro' value=".$filtro." />
  <input type='hidden' name='formula' value=".$formula." />
  <input type='submit' value='".GetLangVar('nameeditar')." ".strtolower(GetLangVar('nameformula'))."' class='bblue' />
</form>
</td>
</tr>
</table>";

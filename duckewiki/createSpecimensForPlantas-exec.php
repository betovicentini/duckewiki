...
$qq  = "SELECT spid,PlantaID,PlantaTag FROM (SELECT IF(sp.EspecimenID>0,sp.EspecimenID,0) as spid,pl.PlantaID,pl.PlantaTag FROM Plantas as pl LEFT JOIN Especimenes as sp ON sp.PlantaID=pl.PlantaID WHERE pl.FiltrosIDS LIKE '%filtroid_".$filtro."%') as zz WHERE zz.spid=0";
//echo $qq."<br>";

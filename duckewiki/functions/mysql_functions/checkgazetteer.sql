CREATE FUNCTION checkgazetteer(gaztxt varchar(500),parid int(10), muniid int(10), provid int(10), countrid int(10)) RETURNS INT
BEGIN
DECLARE gazid INT(10) DEFAULT 0;
DECLARE nmacthes INT(10) DEFAULT 0;
IF (parid>0) THEN
/*LOWER(CONCAT(GazetteerTIPOtxt,' ',Gazetteer)) */

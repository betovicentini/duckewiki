CREATE FUNCTION gettaxonname2(identid INT(10), famid INT(10), genid INT(10), specid INT(10), infspid INT(10), morftp BOOLEAN, autors BOOLEAN ) RETURNS VARCHAR(500)  CHARSET utf8
BEGIN
...
DECLARE idd INT(10) DEFAULT 0;
SET idd = famid+genid+infspid+specid;
IF (identid>0) THEN

...
if ($submeteu=='editando' && empty($especimenid)) {
		header("location: novacoleta-form-teste.php");
}
...
echo "
<tr bgcolor = $bgcolor>
<form name='coletaform' action=novacoleta-exec-teste.php method='post'>
  ...
  <td>
            ...
            <tr>
              ...
              <td class='tdformnotes'>
                <table>
                  <tr>
                    <td>"; 
					autosuggestfieldval3($localfile,'locality',$locality,'localres','localidadeid',$localidadeid,true,60);
			echo "
                    </td>
                  </tr>
                  <tr>
	...
	if (empty($locidadeall) || $locidadeall==2) {
		...
		echo "
            <td>
              <input type='hidden' name='locidadeall' value=''>
              <input type='submit' value='Ver apenas Brasil na lista' onclick=\"javascript:document.coletaform.locidadeall.value=2\">
            </td>";
	}
      ...
      <td>
        <table>
          <tr>
            ...
            <td class='tdformnotes'>"; 
              autosuggestfieldval3('search-gpspoint.php','gpspt',$gpspt,'gpsres','gpspointid',$gpspointid,true,60); 
	echo "
            </td>
            <td align='left' class='tdformnotes'>*selecione da lista</td>
          </tr>
        </table>
      </td>
    </tr>
  ...
  <td colspan=100%>
    <table align='center' >
      <tr>
        ...
        <td align='left'><input type='submit' value='".GetLangVar('messagesalvareduplicar')."' class='bblue' onclick=\"javascript:document.coletaform.final.value=2\"></td>";
			//<td align='left'>
			//	<input type='submit' value='".GetLangVar('salvareproxima')."' class='borange' onclick=\"javascript:document.coletaform.final.value=3\">
			//</td>
echo "
</form>
<form action=novacoleta-form-teste.php method='post'>

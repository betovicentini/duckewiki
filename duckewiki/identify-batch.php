      ...
      <tr>
        ...
        <td id='especimenestxt'>$especimenestxt</td>";
			$myurl = "selectespecimene-popup.php?elementid=especimenesids&elementtxtid=especimenestxt";
				$butname = GetLangVar('nameselect')." ".strtolower(GetLangVar('namecoleta'))."s";
		echo "
		...
		if (!empty($filtro)) {
			...
			echo "
            <option selected value=''>".strtolower(GetLangVar('nameselect')." ".GetLangVar('namefiltro'))."</option>";
      ...
      <tr>
        <td>
          <select name='coletorid'>
            <option selected value=''>".GetLangVar('nameselect')." ".strtolower(GetLangVar('namecoletor'))."</option>";

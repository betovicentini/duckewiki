...
&nbsp;
<input type='button'  onmouseover=\"Tip('Marca como do projeto amostras que estão em um filtro');\"  style=\"color:#4E889C; font-size: 1.2em; font-weight:bold; padding: 4px; cursor:pointer;\"  value='Importar de filtro' ";

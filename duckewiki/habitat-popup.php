...
if (isset($finnal) || isset($imgdone)) {
	...
	/////////////////////
		...
		if (count($newimagefile)>0) {
			...
			$returnto = $serv."/".$zz[1]."/habitat-popup.php";
...
<table class='erro' align='center' cellpadding='7'>
  <tr><td>".GetLangVar('erro1')."</td></tr>";
	if ($ppid==0) {
		echo "
  <tr><td class='tdformnotes'>".strtolower(GetLangVar('habitatclasse'))."</td><tr>";
	}
	if ($locid==0) {
		echo "
  <tr><td class='tdformnotes'>".strtolower(GetLangVar('namelocalidade'))."</td><tr>";
	}
	echo "
</table>
<br/>";
		...
		if ($hbid==0 && $locid>0) {
			...
			if ($rdo>0) {
				...
				echo "
<br/>
<form action='habitat-popup.php' method='post'>
...
<tr>
  <td >
<form name='finalform' action='habitat-popup.php' method='post'>
  <input type='hidden' name='elementidval' value='$elementidval' />
  <input type='hidden' name='elementidtxt' value='$elementidtxt' />
  <input type='hidden' name='ispopup' value='$ispopup' />
...
echo "
<br/>
<form id=\"varform2\" name=\"myformvar\" method=\"post\" enctype=\"multipart/form-data\" action=\"habitat-popup.php\" >
...
<tr bgcolor ='".$bgcolor."'>
  <td colspan='100%'>
    <table>
      <!--- <tr><td style=\"color: #336600; font-size: 1em; text-align: left\" colspan='100%'>".$localtxt."</td></tr> --->
      <tr>
        <td class='tdformleft' style=\"color: #990000;\">".GetLangVar('namelocalidade')."*</td>
        <td class='tdformnotes'>"; autosuggestfieldval3('search-gazetteer.php','locality',$locality,'gazres','gazetteerid',$gazetteerid,true,100); 
echo "</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class='tdformnotes' >"; autosuggestfieldval3('search-gpspoint.php','gpspt',$gpspt,'gpsres','gpspointid',$gpspointid,true,100); 
	echo "</td>
      </tr>
    </table>
  </td>
...
<tr>
  <td  colspan='100%' align='right' >
    ...
    <a onclick=\"javascript:document.getElementById('traitlang').value=".$flagval.";document.getElementById('varform2').submit();\"><img height='30' src=\"icons/".$flag."\" alt='Mudar idioma' style='cursor: pointer;' /></a>
  </td>
</tr>
<tr>
...
<form action='habitat-popup.php' method='post' id='resetform'>
  <input type='hidden' name='ispopup' value='$ispopup' />
  <input type='hidden' name='elementidval' value='$elementidval' />
  <input type='hidden' name='elementidtxt' value='$elementidtxt' />
</form>

        ...
        if (code.indexOf("[[")!=-1){
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return "(dhtmlx.agrid.cells(\""+$2+"\","+$3+").getValue()*1)";
              }
          );
        }
        ...
        if (code.indexOf(":")!=-1){ 
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return '(dhtmlx.agrid.cells("'+id+'",dhtmlx.agrid.getColIndexById("'+$1+'")).getValue()*1)';
              }
          );
        }
        else{
          ...
          code=code.replace(test,
              function ($0,$1,$2,$3){
                  ...
                  return "(dhtmlx.agrid.cells(\""+id+"\","+$1+").getValue()*1)";
              }
          );
        }

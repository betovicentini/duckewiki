...
$qqz = "DROP TABLE `temp_exportespecimenes".substr(session_id(),0,10)."`";
mysql_query($qqz,$conn);
$qqz = "CREATE TABLE `temp_exportespecimenes".substr(session_id(),0,10)."`  (`percentage` INT(10) NOT NULL DEFAULT 0) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci";
mysql_query($qqz,$conn);
//echo $qqz;
$qqz = "INSERT INTO `temp_exportespecimenes".substr(session_id(),0,10)."` (`percentage`) VALUES ('0');";
mysql_query($qqz,$conn);

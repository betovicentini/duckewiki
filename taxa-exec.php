...
<table class='myformtable' align='center' width='70%'>
<thead>
<tr >
<td colspan=4 class='tabhead'>".GetLangVar('nameeditar')."&nbsp;".strtolower($toedit)." &nbsp;<i>$spnome</i></td>
</tr></thead><tbody>";
if ($toedit!=GetLangVar('namefamily')) {
echo "<tr>";
if ($toedit==GetLangVar('namegenus')) {
...
echo " name='nomevalido' value=1 >".strtolower(GetLangVar('namevalido'))."&nbsp;&nbsp;
<input type='radio' "; 
if ($nomevalido==0) { echo "checked";}
echo " name='nomevalido' value=0 >".strtolower(GetLangVar('nameinvalido'))."
</td>
</tr>";
if ($toedit!=GetLangVar('namefamily')) {
echo "<tr>

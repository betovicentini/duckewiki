...
WHERE pltb.FiltrosIDS LIKE '%filtroid_".$filtroid.";%'  OR pltb.FiltrosIDS LIKE '%filtroid_".$filtroid."')";
$sql2 = 
"(SELECT 
spec.SpectrumID AS SPECTRUM_ID,
...
spec.Face,
spec.FileName
FROM NirSpectra AS spec JOIN Especimenes as pltb ON pltb.EspecimenID=spec.EspecimenID JOIN Pessoas as colpessoa ON pltb.ColetorID=colpessoa.PessoaID
WHERE pltb.FiltrosIDS LIKE '%filtroid_".$filtroid.";%'  OR pltb.FiltrosIDS LIKE '%filtroid_".$filtroid."')";

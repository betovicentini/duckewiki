CREATE FUNCTION traitvaluespecs_grid(ttid int(10), pltid int(10), specid int(10), trunit char(100), somedia BOOLEAN, somax BOOLEAN) RETURNS CHAR(100) CHARSET utf8
BEGIN

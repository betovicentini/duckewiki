...
if (($plantaid==0 || !isset($plantaid)) && $ispopup==1) {
	echo "
<form >
...
if (($gpspointid>0 || $gazetteerid>0)) {
	$qq = "SELECT localidadestring(".$gazetteerid.",".$gpspointid.",0,0,0,".($latdec+0).", ".($longdec+0).", ".($altitude+0).") as locality";
	//echo $qq."<br>";
...
<table cellpadding=\"5\" align='center' class='success'>
  ...
  if ($ispopup==1) {
	echo  "
  <tr><td class='tdsmallbold' align='center'><input  style='cursor:pointer' type='button' value='Concluir' onclick=\"javascript:this.window.close()\"</td></tr>";
  } else {
	echo  "
  <tr><td class='tdsmallbold' align='center'><input  style='cursor:pointer' type='submit' value='Concluir'></td></tr>";
  }
echo "
</table>
<br>
...
echo "
<br>
<table class='myformtable' align='left' cellpadding='6' width=90%>
<thead>
  <tr><td colspan='100%' >".$ed." ".mb_strtolower(GetLangVar('nametaggedplant'))."</td>
</tr>
</thead>
<tbody>
";
...
if (!empty($plantnum)) {
echo "
<form name='coletaform' action='planta-exec-popup.php' method='post' >
  ...
  <td >
    <table align='left' cellpadding=\"7\" cellspacing=\"0\" class='tdformnotes'>
      ...
      <tr>
		...
		echo "
        <td align='center'><input  style='cursor:pointer' type=button value='$buthab' class='bsubmit' onclick = \"javascript:small_window('habitat-popup-teste.php?pophabitatid=$habitatid&elementidval=habitatidfield&elementidtxt=habitatfield&opening=1',850,400,'Selecione um habitat');\"></td>
      </tr>
    </table>
  </td>
</tr>";
  ...
  <td >
    <table  align='left' border=0 cellpadding=\"3\" cellspacing=\"0\">
      <tr>
        ...
        <td align='left'><input  style='cursor:pointer'  type=button value=\"".GetLangVar('nameselect')."\" class='bsubmit' onclick = \"javascript:small_window('variacao-popup.php?&elementid=traitids&working=work',700,500,'EntrarVariacao');\"></td>
      </tr>
    </table>
  </td>
</tr>";
  ...
  <td >
    <table  align='left' border=0 cellpadding=\"3\" cellspacing=\"0\">
      <tr>
        ...
        <td align='left'>
        <input  style='cursor:pointer' type=button value=\"".GetLangVar('nameselect')."\" class='bsubmit'></td>
      </tr>
    </table>
  </td>
</tr>";

...
<input  type='submit'  style=\"cursor:pointer;\"   value='Exportar dados INPA'  onclick=\"javascript:document.coletaform.final.value='1'\" ></td>";
if ($acclevel=='admin') {
echo "
<td><input  type='submit'  style=\"cursor:pointer;\"   value='Prepara Imagens para INPA'  onclick=\"javascript:document.coletaform.final.value='2'\" ></td>";
} else {
echo "<td>&nbsp;</td>";
}
echo "
...
if ($acclevel=='admin') {
echo "
<td><input  type='submit'  style=\"cursor:pointer;\"   value='Listas doações herbários'  onclick=\"javascript:document.coletaform.final.value='3'\" ></td>";
} else {
echo "<td>&nbsp;</td>";
}
echo "
<td><input  type='submit'  style=\"cursor:pointer;\"   value='Imprime Lista Para Herbário'  onclick=\"javascript:document.coletaform.final.value='4'\" ></td>
 </tr>
 </td>
 </table>
</tbody>
...
<tr>
<td><input type='submit' value='Exportar' style=\"cursor:pointer;\" />
</tr>
</table>
...
<tr>
<td><input type='submit' value='Gerar' style=\"cursor:pointer;\" />
</tr>
</table>
</form>";
	}

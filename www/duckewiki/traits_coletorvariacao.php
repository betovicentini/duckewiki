	...
	if (!isset($imgdone)) {
	   $arval = $ppost;
		...
		if ($final==1) {
			...
			echo "
<br>
  <table class='sucessosmall' align='left' cellpadding='7'>
...
echo " onclick=\"javascript:alert('$help');\" />&nbsp;&nbsp;
      ...
      <td><input type=button style=\"cursor:pointer;\"  value='Bibliografia'  onmouseover=\"Tip('Indique referência(s) bibliográfica(s) de onde a informação das variáveis está sendo extraída');\" ";

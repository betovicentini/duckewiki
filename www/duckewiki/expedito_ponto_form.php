...
<tbody>
<form action='expedito_ponto_form.php' method='post'>
...
<tbody>
  <form name='coletaform' action='expedito_ponto_form.php' method='post'>
    <input type='hidden' name='ispopup'  value='".$ispopup."' />
...
echo "
<form name='myform' action='expedito_ponto_exec.php' method='post'>
  <input type='hidden' name='expeditoid'  value='".$expeditoid."' />
  <input type='hidden' name='ispopup'  value='".$ispopup."' />

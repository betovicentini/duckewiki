...
HTMLheaders('');
		...
		$famurl = "http://www.mobot.org/mobot/research/apweb/orders/".mb_strtolower($ordem)."web.htm#".$nn;
		$resurl = file_exists($orderurl);
		if (!$resurl) {
			$orderurl = "http://www.mobot.org/mobot/research/apweb/orders/".mb_strtolower($ordem)."web2.htm#".$ordem;
			$famurl = "http://www.mobot.org/mobot/research/apweb/orders/".mb_strtolower($ordem)."web2.htm#".$nn;

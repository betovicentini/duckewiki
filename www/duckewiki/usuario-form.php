...
echo "
<thead>
<tr><td colspan='2'>".GetLangVar('namecadastrar')." ".mb_strtolower(GetLangVar('nameor'))." ".mb_strtolower(GetLangVar('nameeditar'))." ".mb_strtolower(GetLangVar('nameuser'))."</td></tr>
</thead>
<tbody>
<tr>
...
if ($submitted=='editando') {
	...
	$email = $ww['Email'];
	echo GetLangVar('nameeditando')." ".mb_strtolower(GetLangVar('namecadastro'))." ".$quem;
...
<tr bgcolor = '".$bgcolor."'>
  <td class='tdsmallbold' align='right'>";
			if ($_SESSION['editando']==1) {
			  	echo  GetLangVar('namenova')." ".mb_strtolower(GetLangVar('namepwd'))."&nbsp;

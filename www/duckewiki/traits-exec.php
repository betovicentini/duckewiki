...
if (!empty($traitid) && $traitid!=GetLangVar('nameselect')) {	
	...
	echo "<tr class='tabhead'><td colspan=2>".GetLangVar('nameeditar')." ".mb_strtolower($traitkind);
	if ($traitkind!=$traittipo) { echo " (".mb_strtolower($traittipo).")";}
	echo "</td></tr>";
} else {
	echo "<table width='80%' class='tableform' cellpadding=\"3\" align='center'>";
	echo "<tr class='tabhead'><td colspan=2>".GetLangVar('namecadastrar')." ".mb_strtolower($traitkind)."</td></tr>";
}

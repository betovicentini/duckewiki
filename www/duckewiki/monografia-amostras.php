...
if(!isset($uuid) || (trim($uuid)=='') || $acclevel=='visitor') {
	$hidefields = array("EspecimenID","PROJETO", "LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","EDIT","DetID","GazetteerID","GPSPointID","PlantaTag","PlantaID");
	}
	else {
	$hidefields = array("EspecimenID", "PROJETO", "LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","DetID","GazetteerID","GPSPointID","PlantaTag","PlantaID");
}
$i=1;

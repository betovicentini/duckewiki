...
<tr>
<td align='center'>
<input type='submit'  value=\"Adicionar ".($numerodecols+1)." especimenes\"  style=\"cursor:pointer;\"  >
</td>
</tr>
</table>
</form>";
...
//$sql .= " IF(projetologo(pltb.ProjetoID)<>'',projetologo(pltb.ProjetoID),'') as PRJ, 
    ...
    <table>
      <tr>
        ...
        <td>
          ...
          <input type=button value=\"SELECIONAR\" style=\"cursor:pointer;\"     ";
...
echo " onclick=\"javascript:alert('$help');\" /></td>
      <td>"; 
		...
		echo "
      &nbsp;<span style=' font-size: 0.8em; font-weight: bold; color: red;' >*selecione digitando...ou adicione uma <input type=button style=\"cursor:pointer;\"    value='".GetLangVar('namenova')."'  onclick =\"javascript:small_window('".$myurl."',900,300,'Cadastrar nova localidade');\" /> localidade</span></td>";
		echo "
		</tr>
		<tr>
      <td colspan='4' >&nbsp;</td>
  ...
  <td >
    <table align='left' cellpadding=\"7\" cellspacing=\"0\" class='tdformnotes'>
      ...
      <tr>
        ...
        <td align='center'><input type='button' value='SELECIONAR' style=\"cursor:pointer;\"    onclick = \"javascript:small_window('habitat-popup.php?ispopup=1&pophabitatid=$habitatid&elementidval=habitatidfield&elementidtxt=habitatfield&opening=1',850,400,'Selecione um habitat');\" /></td>
      </tr>
    </table>
  </td>
</tr>";
  ...
  <td colspan='2'>
    <table align='center' >
      <tr>
        ...
        <td align='center' ><input style=\"cursor:pointer;\"    type='submit' value='".GetLangVar('namesalvar')."' onclick=\"javascript:document.coletaform.final.value='1'\" /></td>
      </tr>
    </table>
  </td>
</tr>

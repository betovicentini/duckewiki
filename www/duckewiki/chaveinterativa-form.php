...
//echopre($ppost);
$tempfile = "temp_chaveinterativa".$_SESSION['userid']."_".substr(session_id(),0,10);
...
"<script>
    function CheckProgress() {
      ...
      $.get('chaveinterativa-progress.php', { t: time }, function (odado) {
    ...
    $.ajax(
            {
                type: 'GET',
                url: 'chaveinterativa-script.php?formid=".$formid."',
                async: true,
                success:
                    function (data) {
                        ...
                        window.location = 'chaveinterativa-save.php?resultado='+data;
                    }
            });
   CheckProgress();         
</script>",
...
$body='';
$title = 'Exportando dados de Taxa!';

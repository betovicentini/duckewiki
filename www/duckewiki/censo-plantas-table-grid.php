...
&nbsp;
<input type='button' onclick=\"marcarfiltrados(false)\" onmouseover=\"Tip('Incluir/selecionar para o CENSO registros filtrados');\" style=\"cursor:pointer;\"  value='Incluir filtrados' />
&nbsp;
<input  type='button' onclick=\"marcarfiltrados(true)\" onmouseover=\"Tip('Excluir/desmarcar do CENSO os registros que estão filtrados');\" style=\"cursor:pointer;\"  value='Excluir filtrados' />
&nbsp;
<input type='button' style=\"cursor:pointer;\"  onclick=\"javascript:applyfilter();\" value='Filtrar' );\"  onmouseover=\"Tip('Filtrar registros segundo busca indicada na caixa embaixo de cada coluna.<br >No caso de múltiplas colunas irá usar o argumento AND.<br> Simbolos de &gt; &lt; e = podem especificar buscas numéricas.<br >O símbolo ! antes de uma palavra irá retornar diferente dessa palavra.<br >O símbolo = antes de palavra ou número retorn valores identicos.');\"/>
<span id='pgbar' ></span>
<table>";
...
<input type='button' onclick=\"fecharwin()\" style=\"cursor:pointer;\"  value='Fechar' />
&nbsp;
<input type='button' onclick=\"marcarfiltrados(false)\" onmouseover=\"Tip('Incluir/selecionar para o CENSO os registros que estão filtrados');\" style=\"cursor:pointer;\"  value='Incluir filtrados' />
&nbsp;
<input  type='button' onclick=\"marcarfiltrados(true)\" onmouseover=\"Tip('Excluir/desmarcar do CENSO os registros que estão filtrados');\" style=\"cursor:pointer;\"  value='Excluir filtrados' />
&nbsp;
<input type='button' style=\"cursor:pointer;\"  onclick=\"javascript:updateOutput();\" value='Exportar TXT' onmouseover=\"Tip('Exporta como TXT separado por TAB. Irá exportar os registros que foram carregados. FIXME<br />');\" />
</td>
</tr>    
</table>
<script>

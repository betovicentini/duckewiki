 ...
 document.body.appendChild(el);
     ...
     function marcarfiltrados(excluir) {
       var tot = mygrid.getRowsNum();
        ...
        var loader = dhtmlxAjax.postSync(\"projeto-amostras-process.php\", encodeURI('especimenes='+tt+'&projetoid=".$projetoid."&status='+status+'&uuid=".$uuid."') );
...
$qq = "SELECT * FROM `ProjetosEspecs` WHERE EspecimenID>0 AND ProjetoID=".$projetoid;
...
echo"
O Projeto contém <span id='counter'>".$nrr."</span> amostras
<br />
&nbsp;
<input  type='button' onclick=\"javascript:filtrarmarcados(1);\" onmouseover=\"Tip('Mostrar registros marcados');\" style=\"cursor:pointer;\"  value=\"Ver marcados\" />
&nbsp;
<input  type='button' onclick=\"javascript:filtrarmarcados(0);\" onmouseover=\"Tip('Mostrar todos os registros');\" style=\"cursor:pointer;\"  value=\"Ver todos\" />
&nbsp;
<input type='button' onclick=\"fecharwin();\"  onmouseover=\"Tip('Fecha a janela');\"  style=\"cursor:pointer;\"  value='Fechar' />
&nbsp;
<input type='button'  onmouseover=\"Tip('Marca como do projeto amostras que estão em um filtro');\"  style=\"cursor:pointer;\"  value='Importar de filtro' ";
$myurl ="projeto-fromfiltro.php?projetoid=".$projetoid;
...
<td >
&nbsp;
<input type='button' onclick=\"marcarfiltrados(false)\" onmouseover=\"Tip('Incluir/selecionar para a projeto os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Incluir filtrados' />
&nbsp;
<input  type='button' onclick=\"marcarfiltrados(true)\" onmouseover=\"Tip('Excluir/desmarcar do projeto os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Excluir filtrados' />
&nbsp;
<input  type='button' onclick=\"desmarcartodos(mygrid);\" onmouseover=\"Tip('Desmarcar todos os registros marcados nesta planilha!');\" style=\"cursor:pointer;\"  value='Desmarcar todos' />
&nbsp;
...
mygrid.enablePaging(true,1000,10,'pagingArea',true);

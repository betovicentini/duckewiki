...
<tr>
  ...
  <td class='tdsmallboldleft'>Por ".mb_strtolower(GetLangVar('namelocalidade'))."</td>
...
//-->
    ...
    <td>
      <table>
        <tr>
          ...
          <td>&nbsp;".mb_strtolower(GetLangVar('namefrom'))."&nbsp;</td>
  ...
  <tr>
    <td class='tdsmallboldleft'>".GetLangVar('namedata')." ".mb_strtolower(GetLangVar('namecoleta')).":</td>
    <td >
      <table>
        <tr>
          <td>
    ...
    <table>
      <tr>
        <td >".mb_strtolower(GetLangVar('namefrom')).":</td>
          ...
          <td >".mb_strtolower(GetLangVar('nameto')).":</td>

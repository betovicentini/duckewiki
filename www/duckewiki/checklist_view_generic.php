...
<tr>
  <td align='left'>
<input type='button' onclick=\"marcarfiltrados(false,mygrid, '".$tbname."','".$usertbname."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"padding: 2px; cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;  
<input  type='button' onclick=\"marcarfiltrados(true,mygrid,'".$tbname."','".$usertbname."');\" onmouseover=\"Tip('Excluir/desmarcar os registros que estão filtrados por qualquer coluna!');\" style=\"padding: 2px; cursor:pointer;\"  value='Desmarcar filtrados' />
&nbsp;
<input  type='button'  onclick=\"exportarCSV(mygrid,'".$exportcols."');\" style=\"padding: 2px; cursor:pointer;\"  value='Exportar'  onmouseover=\"Tip('Exportar os registros que estão filtrados - DICA: marcar os que deseja e filtrar por Marcado=1');\" />

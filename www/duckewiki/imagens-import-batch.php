...
<tr bgcolor = '".$bgcolor."'>
  <td >
    <table cellpadding='4'>
      <tr>
        <td class='tdsmallbold' style='color: #990000;'>".GetLangVar('nameamostra')."s&nbsp;".mb_strtolower(GetLangVar('namecoletada'))."s&nbsp;<img height=15 src=\"icons/icon_question.gif\"";
...
<tr bgcolor = '".$bgcolor."'>
  <td>
    <table cellpadding='7'>
      <tr>
        <td class='tdsmallbold' style='color: #990000;'>".GetLangVar('nameplanta')."s&nbsp;".mb_strtolower(GetLangVar('namemarcada'))."s&nbsp;<img height=15 src=\"icons/icon_question.gif\"";

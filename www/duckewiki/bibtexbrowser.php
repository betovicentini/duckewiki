...
define('BIBTEXBROWSER','v20130328');
...
class StateBasedBibtexParser {
  ...
  function parse($bibfilename) {
    ...
    $delegate->beginFile();
    if (is_readable($bibfilename)) {
    	//echo "SIM O ARQUIVO PODE SER LIDO<br />";
    } else {
    	//print_r( alt_stat($bibfilename));
    	//echo decoct(fileperms($bibfilename) & 0777);
		//echo "NAO O ARQUIVO  NAO PODE SER LIDO!<br />";
    }
...
class BibEntry {
  ...
  function getType() {
    ...
    return mb_strtolower($this->getField(Q_INNER_TYPE));
  }
...
//     echo $this->getKey();
  ...
  */
  ...
  function addHomepageLink($author) {
    ...
    $homepage = mb_strtolower('hp_'.preg_replace('/ /', '', $author));
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
   <channel>
      ...
      <generator>bibtexbrowser v20130328</generator>
...
class Dispatcher {
  ...
  function diagnosis() {
    ...
    echo "bibtexbrowser version: 20130328\n";

...
*/
dhtmlXGridObject.prototype.enableAutoSizeSaving=function(b,a){this.attachEvent("onResizeEnd",function(){this.saveSizeToCookie(b,a)})};dhtmlXGridObject.prototype.saveOpenStates=function(b,a){if(!b)b=this.entBox.id;var c=[];this._h2.forEachChild(0,function(a){a.state=="minus"&&c.push(a.id)});var d="gridOpen"+(b||"")+"="+c.join("|")+(a?"; "+a:"");document.cookie=d};dhtmlXGridObject.prototype.loadOpenStates=function(b){var a=this.getCookie(b,"gridOpen");if(a)for(var a=a.split("|"),c=0;c<a.length;c++)this.openItem(a[c])};
dhtmlXGridObject.prototype.enableAutoHiddenColumnsSaving=function(b,a){this.attachEvent("onColumnHidden",function(){this.saveHiddenColumnsToCookie(b,a)})};dhtmlXGridObject.prototype.enableSortingSaving=function(b,a){this.attachEvent("onBeforeSorting",function(){var c=this;window.setTimeout(function(){c.saveSortingToCookie(b,a)},1);return!0})};dhtmlXGridObject.prototype.enableOrderSaving=function(b,a){this.attachEvent("onAfterCMove",function(){this.saveOrderToCookie(b,a);this.saveSizeToCookie(b,a)})};
dhtmlXGridObject.prototype.enableAutoSaving=function(b,a){this.enableOrderSaving(b,a);this.enableAutoSizeSaving(b,a);this.enableSortingSaving(b,a)};dhtmlXGridObject.prototype.saveSizeToCookie=function(b,a){var c=this.cellWidthType=="px"?this.cellWidthPX.join(","):this.cellWidthPC.join(","),d=(this.initCellWidth||[]).join(",");this.setCookie(b,a,0,c);this.setCookie(b,a,1,d)};
dhtmlXGridObject.prototype.saveHiddenColumnsToCookie=function(b,a){var c=[].concat(this._hrrar||[]);if(this._fake&&this._fake._hrrar)for(var d=0;d<this._fake._cCount;d++)c[d]=this._fake._hrrar[d]?"1":"";this.setCookie(b,a,4,c.join(",").replace(/display:none;/g,"1"))};dhtmlXGridObject.prototype.loadHiddenColumnsFromCookie=function(b){var a=this._getCookie(b,4),c=(a||"").split(",");if(!(c.length>this._cCount)&&a)for(var d=0;d<c.length;d++)this.setColumnHidden(d,c[d]?!0:!1)};
dhtmlXGridObject.prototype.saveSortingToCookie=function(b,a){this.setCookie(b,a,2,(this.getSortingState()||[]).join(","))};dhtmlXGridObject.prototype.loadSortingFromCookie=function(b){var a=this._getCookie(b,2),a=(a||"").split(",");a.length>1&&a[0]<this._cCount&&(this.sortRows(a[0],null,a[1]),this.setSortImgState(!0,a[0],a[1]))};
dhtmlXGridObject.prototype.saveOrderToCookie=function(b,a){if(!this._c_order){this._c_order=[];for(var c=this._cCount,d=0;d<c;d++)this._c_order[d]=d}this.setCookie(b,a,3,(this._c_order||[]).slice(0,this._cCount).join(","));this.saveSortingToCookie()};

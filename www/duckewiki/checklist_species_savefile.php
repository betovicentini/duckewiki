...
$stringData .= "   \$imgg33 =\"<img style='cursor:pointer;' src='icons/nota-icon.png' height='16' onclick=\\\"javascript:small_window('".$url."/traits_coletortaxa.php?nomesciid=\".\$nomesciid.\"&taxanome=\$nameedit',800,800,'Editando notas');\\\"  onmouseover=\\\"Tip('Edita notas do taxon # \".\$tropicos.\"');\\\" >\";";
$stringData .= "

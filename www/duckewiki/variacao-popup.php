...
//echo $final1." AQUI SEMPRE $final  $elementid<BR>";
...
@extract($aa);
//echo "POST:<BR>".echopre($_POST);
//echo "_GET:<BR>".echopre($_GET);
//echo "aa:<BR>".echopre($aa);
	...
	foreach ($arval as $key => $value) {	//para cada variavel no array	
		...
		if (count($newimagefile)>0) {
			...
			'formid' => $_POST['formid']);	
					...
					$returnto = $serv."/".$zz[1]."/variacao-popup.php";
...
echo "
<table class='myformtable' align='left' cellpadding='5' cellspacing='0'> 
<thead>
<tr>
...
<tr>
<td align='center' >
<form id='varform2' method='POST' enctype='multipart/form-data' action='variacao-popup.php' >

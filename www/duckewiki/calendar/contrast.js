...
var gWeekDay=["D","S","T","Q","Q","S","S"];	// weekday caption from Sunday to Saturday
...
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Hoje</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
...
var gsTodayTip="Hoje";	// tooltip for today

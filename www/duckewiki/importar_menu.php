...
echo "<br>";
echo "<a style=\"width: ".$minwidth .";\" href=\"#\" class=\"menuicons_amarelo\" onclick = \"javascript:small_window('imagens-import-batch.php?ispopup=1',1000,500,'Importar Imagens');\">Importar Imagens</a>";
echo "<br>";
...
echo "<br>";
if ($acclevel=='admin') {
echo "<a style=\"width: ".$minwidth .";\" href=\"#\" class=\"menuicons_amarelo\" onclick = \"javascript:small_window('imagens-link.php?ispopup=1',1000,500,'Importar Imagens');\">Ligar Imagens Importadas</a>";
echo "<br>";

CREATE FUNCTION traitvariation_specimens(ttid int(10), specid int(10), trunit BOOLEAN, somedia BOOLEAN) RETURNS  VARCHAR(1000) 
BEGIN
...
DECLARE toprint VARCHAR(1000) DEFAULT '';
...
DECLARE statevariation VARCHAR(1000)  DEFAULT '';

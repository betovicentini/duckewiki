...
DECLARE cur1 CURSOR FOR SELECT trt.TraitID,trt.TraitTipo,trt.TraitName,trt.PathName,moni.TraitVariation,moni.TraitUnit,moni.DataObs FROM Monitoramento as moni JOIN Traits as trt USING(TraitID) JOIN FormulariosTraitsList ON FormulariosTraitsList.TraitID=trt.TraitID  WHERE moni.PlantaID=habid AND FormulariosTraitsList.FormID=formid  ORDER BY trt.PathName,trt.TraitID,moni.DataObs;

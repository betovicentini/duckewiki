CREATE FUNCTION parcelafiels(gazid INT(10), gpsptid INT(10), qual VARCHAR(50)) RETURNS VARCHAR(500) CHARSET utf8
BEGIN
DECLARE gaztipo VARCHAR(100) DEFAULT '';
DECLARE gaztxt VARCHAR(100) DEFAULT '';
DECLARE gazpath VARCHAR(500) DEFAULT '';
...
DECLARE partxt VARCHAR(500) DEFAULT '';

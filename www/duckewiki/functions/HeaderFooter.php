...
<img  src=\"icons/".$sitelogo."\"  height='80' />&nbsp;<span style='position: relative; top: 20px; vertical-align: top; font-size: 2em; color: #8B0000;' >
".$sitetitle."</span>
</div>";
	} else {
	echo "
<div style='position: absolute; top: 5px; left: 5px; cursor: pointer;' onclick = \"javascript: self.location='index.php?ispopup=1';\" >
<img  src=\"icons/".$sitelogo."\"  height='80' />&nbsp;<span style='position: relative; top: 5px; vertical-align: top; font-size: 1.5em; color: #8B0000;' >
".$sitetitle."</span>
</div>
...
echo "
<div id='container'  style='position: absolute; top: 100px;  padding-left: 5px;'>
";
}  else {
echo "
<div id='container'  style='top: 15px;  padding-left: 5px;'>
";
}
...
<div style='position: absolute; top: 1000px; width: 100%; align: center;' >
";
...
<table align='center'>
   <tr>
     <td align='center'>
        <img style='border: 0px; height: ".$height."px; cursor: pointer;'  src='icons/inpa_principal.jpg' alt='INPA'  onclick = \"javascript: window.open('http://www.inpa.gov.br','_blank' );\" onmouseover = \"javascript: Tip('Instituto Nacional de Pesquisas da Amazônia - INPA') ;\" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     </td>
     <td align='center'>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img style='border: 0px; height: ".$height."px; cursor: pointer;'  src='icons/fapeam.png' alt='FAPEAM'  onclick = \"javascript: window.open('http://www.fapeam.am.gov.br/','_blank' );\" onmouseover = \"javascript: Tip('Fundação de Amparo à Pesquisa do Estado do Amazonas - FAPEAM') ;\"  />&nbsp;&nbsp;&nbsp;
     </td>
   </tr>
 </table>";
} else {

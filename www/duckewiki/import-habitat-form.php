...
$title = 'Importar variáveis ambientais';
$body = '';
...
<thead>
<tr>
<td colspan='100%' class='tabhead' >Importar dados de HABITAT</td>
</tr>
</thead>
<tbody>";
...
echo "
<tr bgcolor = '".$bgcolor."'>
<form enctype='multipart/form-data' action='import-habitat-step1.php' method='post'>

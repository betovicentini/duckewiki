...
<table cellpadding=\"1\" width='50%' align='center' class='erro'>
	...
	<tr class='tdsmallbold' ><td class='tdsmallnotes' align='center'>".GetLangVar('namedefinicao')."</td></tr>
						...
						$qq = "SELECT * FROM Traits WHERE ParentID='".$parentid."' AND LOWER(TRIM(TraitName))='".mb_strtolower(trim($novo))."' AND TraitTipo='Estado'";
...
<thead>
  <tr><td colspan='2'>As seguintes categorias da variável <b>$tname</b> [coluna ".$orgcol."] não estão cadastradas</td></tr>
  <tr class='subhead'>

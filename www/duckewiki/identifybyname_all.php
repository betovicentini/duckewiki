...
if ($newdetid>0) {
	...
	if ($salvo>0 || $erro==0) {
		...
		echo "
<br />
  <table cellpadding=\"7\" align='center' class='success' width='30%' >
    <tr><td >Sucesso! A identificação de ".$numspecs."  especímenes e ".$numplantas."  plantas foram alteradas e o nome ".$nomesearch." foi apagado do checklist. Não foi atualizada a tabela do checklist para o novo nome.</td></tr>
  </table>
<br />";
		} else {
		echo "
<br />
  <table cellpadding=\"7\"  align='center' class='success' width='30%' >
    <tr><td >Sucesso! A identificação de ".$numspecs."  especímenes e ".$numplantas."  plantas foram alteradas, MAS o nome ".$nomesearch." não foi apagado do checklist. Não foi atualizada a tabela do checklist para o novo nome.</td></tr>
  </table>
<br />";
	...
	if ($erro>0) {
		echo "
<br />
<table  cellpadding=\"7\"  align='center' class='erro' width='30%' >
  <tr><td >ERRO no cadastro da identificação das amostras ou plantas</td></tr>
</table>
<br />";
	}
} 

...
$headd = array_merge((array)$headd,(array)array("ESPECIMENES","PLOT", "DUPS","MAP","OBS","HABT","IMG","NIRSpectra","PROJETO"));
...
if(!isset($uuid) || (trim($uuid)=='') || $acceslevel=='visitor' || $uuid==0) {
	$hidefields = array("PlantaID", "TAGtxt", "DetID","PROJETO", "LONGITUDE", "LATITUDE", "ALTITUDE", "PLOT","DUPS","EDIT","GazetteerID","GPSPointID","NOME_AUTOR","MORFOTIPO","DETBY","DETYY");
} 
else {
	$hidefields = array("PlantaID", "TAGtxt", "DetID","PROJETO", "DUPS","GazetteerID","GPSPointID","PLOT","NOME_AUTOR","MORFOTIPO","DETBY","DETYY","LONGITUDE", "LATITUDE", "ALTITUDE");
}
$i=0;

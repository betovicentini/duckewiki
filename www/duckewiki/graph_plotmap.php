...
while ($row = mysql_fetch_assoc($res)) {
	...
	$alts[] = $za;
	//$targ[] = ";
	$targ[] = "javascript:small_window('showplantdescription.php?plantaid=".$row['PlantaID']."',350,350,'Mostrar notas');";
...
$graph->Add($sp1);
//$graph->Stroke();
//$fileName = "temp/teste_imagefile.png";

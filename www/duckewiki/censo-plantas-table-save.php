...
if(!isset($uuid) || (trim($uuid)=='') || $acclevel=='visitor') {
	$hidefields = array("CensoID","PlantaID", "TAGtxt", "PAIS", "ESTADO", "MUNICIPIO", "LOCALSIMPLES", "PROJETO", "MonitoramentoID","TraitPathName","TraitUnit","TraitVariation");
	}
	else {
	$hidefields = array("CensoID", "PlantaID", "TAGtxt", "PAIS", "ESTADO", "MUNICIPIO", "LOCALSIMPLES", "PROJETO", "MonitoramentoID","TraitPathName","TraitUnit","TraitVariation");
}

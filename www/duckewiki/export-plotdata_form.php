...
mysql_query($qqz,$conn);
$qqz = "INSERT INTO `temp_exportplotdata.".substr(session_id(),0,10)."` (`percentage`) VALUES ('1');";
mysql_query($qqz,$conn);
    ...
    function CheckProgress() {
      ...
      $.get('export-plotdata_progress.php', { t: time }, function (data) {
        ...
        if (progress < 100) {
          ...
          window.location = 'export-plotdata-save.php?idd=".$idd."&tableref=".$tableref."';
    }
      });
   }
    ...
    $.ajax(
            {
                ...
                data: 'idd=".$idd."&tableref=".$tableref."',
                async: true,
                success:
                    function (data) {
...
<br />
<div id='procont'>
<span style='text-align: center;' >Estou gerando a planilha...(pode demorar dependendo da quantidade de dados)</span>

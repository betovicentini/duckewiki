...
function amostrasilica(especid, pltid) {
			//var url = 'amostrasilica.php?especimenid='+especid+'&plantaid='+pltid+'&uuid=".$uuid."&hoje=".$today."';
			//alert(url)
         setTimeout(function(){ 
...
FazHeader($title,"",$which_css,$which_java,TRUE);
...
if (!isset($meuprojetoid)) { $meuprojetoid=0;}
omenudeicons($quais, $vertical=FALSE, $position='left' , $iconwidth='30', $iconheight='30',$meuprojetoid);
...
<table id=\"paging_container\">
   ...
   <tr>
    ...
    <tr>
      <td>   ";
if ($exportspecies==1) {      
echo "   <input type='button' onclick=\"marcarfiltrados(false,mygrid, 'checklist_all','".$taxonlist['usertbname']."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;
<input  type='button' onclick=\"desmarcartodos(mygrid, 'checklist_all');\" onmouseover=\"Tip('Desmarcar todos os registros marcados nesta planilha!');\" style=\"cursor:pointer;\"  value='Desmarcar todos' />
&nbsp;
<input  type='button'  onclick=\"exportarCSV(mygrid,'".$taxonlist['exportcols']."');\" style=\"cursor:pointer;\"  value='Exportar Filtrados'  onmouseover=\"Tip('Exportar os registros que estão filtrados - DICA: marcar os que deseja e filtrar por Marcado=1');\" />
...
echo "       
   <input type='button' onclick=\"marcarfiltrados(false,myspecgrid, 'checklist_speclist','".$specimenlist['usertbname']."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;
<input  type='button' onclick=\"desmarcartodos(myspecgrid, 'checklist_speclist');\" onmouseover=\"Tip('Desmarcar todos os registros marcados nesta planilha!');\" style=\"cursor:pointer;\"  value='Desmarcar todos' />
&nbsp;";
if ($uuid>0) {      
echo "       
<input  id='myspecgrid_button' type='button'  onclick=\"salvarmarcados(myspecgrid, 'checklist_speclist','".$specimenlist['usertbname']."');\" style=\"cursor:pointer;\"  value='Filtro - salvar marcados' />
&nbsp;
";
}
echo "       
<input  type='button'  onclick=\"exportarCSV(myspecgrid,'".$specimenlist['exportcols']."');\" style=\"cursor:pointer;\"  value='Exportar Filtrados'  onmouseover=\"Tip('Exportar os registros que estão filtrados - DICA: marcar os que deseja e filtrar por Marcado=1');\" />
...
if ($exportplantas==1) {      
echo "       
   <input type='button' onclick=\"marcarfiltrados(false,myplgrid, 'checklist_pllist','".$plantaslist['usertbname']."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;
<input  type='button' onclick=\"desmarcartodos(myplgrid, 'checklist_pllist');\" onmouseover=\"Tip('Desmarcar todos os registros marcados nesta planilha!');\" style=\"cursor:pointer;\"  value='Desmarcar todos' />
&nbsp;
";
if ($uuid>0) {
echo "     
<input  id='myplgrid_button' type='button'  onclick=\"salvarmarcados(myplgrid, 'checklist_pllist','".$plantaslist['usertbname']."');\" style=\"cursor:pointer;\"  value='Filtro - salvar marcados' />
&nbsp;
 ";
 }
echo"
<input  type='button'  onclick=\"exportarCSV(myplgrid,'".$plantaslist['exportcols']."');\" style=\"cursor:pointer;\"  value='Exportar Filtrados' onmouseover=\"Tip('Exportar os registros que estão filtrados - DICA: marcar os que deseja e filtrar por Marcado=1');\" />
...
<table id=\"paging_container4\">
   ...
   <tr>
    ...
    <tr>
      <td>    ";
if ($exportplots==1) {      
//color:#4E889C; font-size: 1em;   padding: 2px; 
echo "       
   <input type='button' onclick=\"marcarfiltrados(false,myplotgrid, 'checklist_plots','".$plotlist['usertbname']."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;
<input  type='button' onclick=\"desmarcartodos(myplotgrid, 'checklist_plots');\" onmouseover=\"Tip('Desmarcar todos os registros marcados nesta planilha!');\" style=\"cursor:pointer;\"  value='Desmarcar todos' />
&nbsp;
<input  type='button'  onclick=\"exportarCSV(myplotgrid,'".$plotlist['exportcols']."');\" style=\"cursor:pointer;\"  value='Exportar Filtrados' onmouseover=\"Tip('Exportar os registros que estão filtrados');\"/>

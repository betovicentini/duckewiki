...
"<script>
    function CheckProgress() {
      ...
      $.get('export-taxadata-progress.php', { t: time }, function (odado) {
    ...
    $.ajax(
            {
                type: 'GET',
                url: 'export-taxadata-script.php?formid=".$formid."',
                async: true,
                success:
                    function (data) {
                        ...
                        window.location = 'export-taxadata-save.php?resultado='+data;
                    }
            });
   CheckProgress();         
</script>",

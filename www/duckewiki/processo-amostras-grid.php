...
&nbsp;
<input type='button' style=\"cursor:pointer;\"  onclick=\"javascript:updateOutput();\" value='Exportar TXT' onmouseover=\"Tip('Exporta como TXT separado por TAB<br />Rápido, mas precisa visualizar todas as páginas antes de clicar aqui!');\" />
    </div>
  </td>
</tr>";

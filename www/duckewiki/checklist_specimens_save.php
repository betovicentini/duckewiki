...
$headd = array_merge((array)$headd,(array)array("LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","MAP","OBS","HABT","HABT_CLASSE","IMG","NIRSpectra","PROJETO"));
...
$stringData .= "
    ...
    \$imgg4 =\"<img style='cursor:pointer;' src='icons/samples.png' height='20' onclick=\\\"javascript:small_window('".$url."/adiciona_processo.php?onome=\".\$pltag.\"&especimenid=\".\$data->get_value(\"EspecimenID\").\"',700,400,'Adicionando ao processo');\\\"  onmouseover=\\\"Tip('Adiciona a amostra # \".\$pltag.\" a um processo');\\\" >\";
...
\$grid ->render_sql(\"SELECT 0 as Marcado,tb.* FROM ".$tbname." as tb  ".$qwhere." ORDER BY tb.DATA DESC\",\"EspecimenID\",\"".$hdd."\");
?>";
//$mysql = 

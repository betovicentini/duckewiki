...
<br />";
	...
	$qq = "SELECT * FROM Pessoas WHERE LOWER(Prenome)='".mb_strtolower($nome)."' ";
	if (!empty($segnome)) {
		$qq .= " AND LOWER(SegundoNome)='".mb_strtolower($segnome)."'";
	}
	$qq .= " AND LOWER(Sobrenome)='".mb_strtolower($sobrenome)."'";

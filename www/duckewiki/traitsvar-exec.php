...
if ($traitid>0 && is_numeric($traitid)) {
	...
	$titulo = GetLangVar('nameeditar')." ".mb_strtolower($traitkind);
	if ($traitkind!=$traittipo) { $titulo .=  " (".mb_strtolower($nnn).")";}
} 
else {
	$titulo = GetLangVar('namecadastrar')." ".mb_strtolower($traitkind);
}
    ...
    <table align='left' >
      <tr>
        ...
        <td class='tdformnotes'><input type='radio' name='traitunit' ";
			...
			echo "
        <td class='tdformnotes'><input class='tdformnotes' type='text' size=6 value='".$traitunitnew."' name='traitunitnew' />&nbsp;&nbsp;".mb_strtolower(GetLangVar('namenova'))."&nbsp;&nbsp;</td>
      </tr>
    </table>
  </td>
</tr>";

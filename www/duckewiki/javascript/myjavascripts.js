...
var newWindow;
var prop = "left=300,top=100,scrollBars=yes,resizable=yes,toolbar=yes,menubar=yes,location=no,width=";
var prop2 = ", height=";
...
function gethrefvalue(atagid){
	...
	var vf = vvv.join("/");
	var newWindow;
	var prop = "left=300,top=100,scrollBars=yes,resizable=yes,toolbar=no,menubar=no,location=no,directories=no";
	/*window.open(vf); 
	var prop2 = ", height=";
	var teste = prop + mywidth + prop2 + myheight;
	var props = teste;*/
	newWindow = window.open(vf,'',prop);
	newWindow.focus(); 
}

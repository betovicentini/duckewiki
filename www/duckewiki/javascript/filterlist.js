  ...
  this.init = function() {
    ...
    if (this.selectobj && this.selectobj.options) {
      for (var i=0; i < this.selectobj.options.length; i++) {
        ...
        //this.optionscopy[i].style.color = selectobj.options[i].style.color;
        this.optionscopy[i].style.background = selectobj.options[i].style.background;
    ...
    for (loop=0; loop < this.optionscopy.length; loop++) {
      ...
      if ((this.match_text && regexp.test(option.text)) ||
        ...
        this.selectobj.options[index++] =
          new Option(option.text, option.value, option.style, false);

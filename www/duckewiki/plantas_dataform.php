...
$sql .= checklistplantasqq($daptraitid,$alturatraitid,$habitotraitid,$statustraitid,$duplicatesTraitID,$quickview,$quicktbname,$checkoleo=1,$traitsilica);
...
<thead>
  <tr><td colspan='2' >".$ed." ".mb_strtolower(GetLangVar('nametaggedplant'))."</td>
</tr>
</thead>
<tbody>
";
      ...
      <tr>";
        ...
        <td class='tdsmallboldright'>";
          ...
          <input type='checkbox' name='nosample' value='no' ";
				if ($nosample=='no') { echo 'checked';}
				echo ">&nbsp;".GetLangVar('namenao')." ".mb_strtolower(GetLangVar('namecoletada'));
			}
	echo "</td>
      </tr>
    </table>

...
echo "
<br>
<table class='myformtable' align='left' cellpadding='4' width=90%>
<thead>
          ...
          <td colspan='100%'>
            <table >
              <tr>
                ...
                <td class='tdsmallboldright' align='center'>".mb_strtolower(GetLangVar('nameor')." ".GetLangVar('nameselect'))."   ponto GPS</td>
                <td align='center'>

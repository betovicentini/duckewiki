...
<tr>
      <td>    
   <input type='button' onclick=\"marcarfiltrados(false,mygrid, '".$tbname."');\" onmouseover=\"Tip('Marcar/selecionar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Marcar filtrados' />
&nbsp;
<input  type='button' onclick=\"marcarfiltrados(true,mygrid,'".$tbname."');\" onmouseover=\"Tip('Excluir/desmarcar os registros que estão filtrados por qualquer coluna!');\" style=\"cursor:pointer;\"  value='Desmarcar filtrados' />
&nbsp;
<input  id='myspecgrid_button' type='button'  onclick=\"salvarmarcados(mygrid,'".$tbname."');\" style=\"cursor:pointer;\"  value='Formulário - salvar marcados' />
&nbsp;
&nbsp;
&nbsp;
&nbsp;
&nbsp;
<input type='button' style=\"cursor:pointer;\"  onclick=\"javascript:updateOutput();\" value='Exportar TXT' onmouseover=\"Tip('Exporta como TXT separado por TAB!');\" />

...
<br />
<table><tr><td>
<input type='submit' style=\"cursor:pointer;\"  value='Fechar'  onclick='javascript: window.close();' ></td>
<td align='center'>
        <form action='monografia-exec.php' method='post'>
          <input type='hidden' name='ispopup' value='".$ispopup."' />
          <input type='hidden' name='monografiaid' value='".$monografiaid."' />
          <input type='submit' style=\"cursor:pointer;\"  value='Voltar'>
        </form>
</td>
</tr>
</table>
  ...
  <td >
    <table>
      <tr>
        ...
        <td><input type=button style=\"cursor:pointer;\"  value='Autor(es)'  onmouseover=\"Tip('Adiciona ou Edita os Autores do Trabalho');\" ";
  ...
  <td >
    <table>
      <tr>
        ...
        <td><input type=button style=\"cursor:pointer;\"  value='Especimenes'  onmouseover=\"Tip('Adiciona ou Edita as Amostras do Trabalho');\" ";
...
<td class='tdsmallbold'>PASSO 02 - Modelo para descrições&nbsp;&nbsp;<img height='15' src=\"icons/icon_question.gif\" ";
  ...
  <td >
    <table>
      <tr>
        <td><input type=button style=\"cursor:pointer;\"  value='Criar/editar modelo'  onmouseover=\"Tip('Definir um modelo para a descrição');\" ";
        ...
        <td><input type=button style=\"cursor:pointer;\"  value='Visualiza descrições'  onmouseover=\"Tip('Se tiver definido um modelo e especímenes, visualiza as descrições');\" ";
...
<td class='tdsmallbold'>PASSO 03 - Modelo para lista de amostras&nbsp;&nbsp;<img height='15' src=\"icons/icon_question.gif\" ";
  ...
  <td >
    <table>
      <tr>
        <td><input type=button style=\"cursor:pointer;\"  value='Criar/editar modelo lista'  onmouseover=\"Tip('Definir um modelo material examinado');\" ";
		$myurl = "monografila-modelo-listaespecimenes.php?monografiaid=".$monografiaid;
		echo " onclick = \"javascript:small_window('".$myurl."',1000,700,'Modelo Descrição');\" /></td>
		<td ><span id='descricaomodelolista'>".$traittxt2."</span></td>
        <td><input type=button style=\"cursor:pointer;\"  value='Visualiza lista'  onmouseover=\"Tip('Se tiver definido um modelo, visualiza listas');\" ";
...
<tr bgcolor = '".$bgcolor."'>
  <td colspan='2'>
    <table align='center' >
      <tr>
        <td align='center' ><input type='hidden' name='saving' value='1' /><input type='submit' value='".GetLangVar('namesalvar')." ".mb_strtolower(GetLangVar('namedefinicoes'))."' class='bsubmit' /></td>
</form>

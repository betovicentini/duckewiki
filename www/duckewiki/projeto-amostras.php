...
$headd = array_merge((array)$headd,(array)array("LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","MAP","OBS","HABT","IMG","NIRSpectra","PRJ","PROJETO"));
...
"PROJETO" => 0
	...
	if(!isset($uuid) || (trim($uuid)=='') || $acceslevel=='visitor' || $uuid==0) {
		$hidefields = array("EspecimenID","PROJETO", "LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","EDIT","DetID","GazetteerID","GPSPointID","PlantaTag","PlantaID","NOME_AUTOR","MORFOTIPO",'FERTILIDADE');
	} else {
		$hidefields = array("EspecimenID", "PROJETO", "LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","DetID","GazetteerID","GPSPointID","PlantaTag","PlantaID","NOME_AUTOR","MORFOTIPO", "FERTILIDADE");
	}
	$i=1;
...
$stringData .= "
    ...
    if (!empty(\$pj)) {
      \$imagen=\"<img style='cursor:pointer;' src='\".\$data->get_value(\"PRJ\").\"' height='20' onclick=\\\"javascript:alert('\".\$data->get_value(\"PROJETO\").\"');\\\" onmouseover=\\\"Tip('\".\$data->get_value(\"PROJETO\").\"');\\\" >\";

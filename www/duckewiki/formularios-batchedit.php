...
if ($formid>0) {
		header("location: formularios-batchexec.php?ispopup=1&formid=".$formid);
}
//CABECALHO
if ($ispopup==1) {
	$menu = FALSE;
...
$title = 'Formulários BatchEdit';
$body = '';
FazHeader($title,$body,$which_css,$which_java,$menu);

echo "
<br />
<form action='formularios-batchexec.php' method='post'>
  <input type='hidden' name='ispopup' value='$ispopup' />
<table align='center' cellpadding='7' class='myformtable'>
<thead>
<tr ><td colspan='100%'>Organizar ".mb_strtolower(GetLangVar('nameformulario'))."</td>
</tr>
</thead>
<tbody>
<tr>
  <td >
    <table>
      <tr>
        <td class='tdsmallbold'>".GetLangVar('nameselect')." ".GetLangVar('nameformulario')."</td>

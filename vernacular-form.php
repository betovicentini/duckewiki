...
echo "<thead><tr>
<td colspan=100%>
".GetLangVar('namecadastrar')." ".strtolower(GetLangVar('namevernacular'))."
</td>
</tr>
</thead>
<tbody>
<tr>
	...
	<td class='tdformnotes'>
			...
			if (!isset($vernacularid)) {
				echo "<option value=''>".GetLangVar('nameselect')." ".strtolower(GetLangVar('nameeditar'))."</option>";
			} else {
...
if ($submitted=='editando') {
	...
	$obs = $ww['Notes'];
	echo GetLangVar('nameeditando')." ".strtolower(GetLangVar('namecadastro'))." ".$nome;

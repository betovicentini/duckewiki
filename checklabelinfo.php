...
$headd = array("EDIT","COLETOR", "NUMERO", "DATA", "INPA_N", "FAMILIA", "NOME", "PAIS", "ESTADO", "MUNICIPIO", "LOCAL", "LONGITUDE", "LATITUDE", "ALTITUDE", "DUPS","MAP","OBS","HABT","IMG","PRJ","PROJETOstr","EXSICATA_IMG");
...
$hidefields = array("PROJETOstr", "EXSICATA_IMG");
$i=1;
...
function custom_format(\$data){
    ...
    \$imagen=\"<img style='cursor:pointer;' src='\".\$data->get_value(\"PRJ\").\"' height='20' onclick=\\\"javascript:alert('\".\$data->get_value(\"PROJETOstr\").\"');\\\" alt='Sobre o projeto' >\";

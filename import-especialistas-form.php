...
<thead>
<tr>
<td colspan='100%' class='tabhead' >".GetLangVar('nameimportar')." especialistas</td>
</tr>
</thead>
<tbody>";
...
echo "
<tr bgcolor = '".$bgcolor."'>
<form enctype='multipart/form-data' action='import-especialistas-step1.php' method='post'>
